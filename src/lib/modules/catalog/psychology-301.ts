...
export const Psychology301Module: LearningModule = {
  "id": "psychology-301",
      ...
      "chunks": [
        {
          ...
          "content": "Psychology at level 301 requires precise language. We define scope boundaries, identify the operating unit of analysis, and align terminology so decisions can be compared across teams."
        },
        {
