...
export const MusicProduction501Module: LearningModule = {
  "id": "music-production-501",
  "title": "Music Production Specialization Studio",
      ...
      "questions": [
        {
          ...
          "skillId": "music-production-501-skill-core",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "text": "At level 501, strong execution for music operations and execution design requires:",
          "skillId": "music-production-501-skill-execution",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "music-production-501-skill-eval",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "music-production-501-skill-advanced-5",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "text": "In high-stakes Music Production Specialization Studio execution, which communication protocol is strongest?",
          "skillId": "music-production-501-skill-advanced-6",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "music-production-501-skill-advanced-7",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "text": "Which portfolio decision rule best balances performance and resilience in Music Production Specialization Studio?",
          "skillId": "music-production-501-skill-advanced-8",
          "options": [
            {
              "id": "a",
      ...
      "questions": [
        {
          ...
          "skillId": "music-production-501-skill-case1",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "music-production-501-skill-case2",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "music-production-501-skill-case3",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "music-production-501-skill-case4",
          "options": [
            {
              "id": "a",
