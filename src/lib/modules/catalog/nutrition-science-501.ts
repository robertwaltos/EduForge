...
export const NutritionScience501Module: LearningModule = {
  ...
  "lessons": [
    {
      ...
      "title": "Nutrition Science Advanced Foundations",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
    ...
    },
    {
      ...
      "title": "Nutrition Science Specialist Methods Lab",
      "type": "interactive",
      "duration": 17,
      "learningAids": [
        {
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "nutrition-science-501-l03-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured approach, document assumptions, and verify outcomes with measurable criteria."
        }
      ...
      "questions": [
        {
          ...
          "text": "Which practice most improves metabolic evidence interpretation decision quality?",
        ...
        },
        {
          ...
          "text": "At level 501, high-quality execution for intervention protocol design requires:",
        ...
        {
          "id": "nutrition-science-501-l03-q5",
        ...
        {
          "id": "nutrition-science-501-l03-q6",
          "text": "In high-stakes Nutrition Science Specialization Studio execution, which communication protocol is strongest?",
          "skillId": "nutrition-science-501-skill-advanced-6",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "nutrition-science-501-l03-q7",
          "text": "A mature remediation loop in advanced Health Science should prioritize:",
          "skillId": "nutrition-science-501-skill-advanced-7",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "nutrition-science-501-l03-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Nutrition Science Specialization Studio?",
          "skillId": "nutrition-science-501-skill-advanced-8",
          "options": [
            {
              "id": "a",
    ...
    },
    {
      ...
      "title": "Nutrition Science Advanced Case Analysis",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
    ...
    },
    {
      ...
      "title": "Nutrition Science Simulation and Defense Studio",
      "type": "interactive",
      "duration": 17,
      "learningAids": [
        {
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "nutrition-science-501-l06-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured approach, document assumptions, and verify outcomes with measurable criteria."
        }
      ...
      "questions": [
        ...
        {
          "id": "nutrition-science-501-l06-q5",
          "text": "What is the best way to compare competing interventions in advanced Health Science?",
          "skillId": "nutrition-science-501-skill-advanced-5",
          "options": [
            {
        ...
        {
          "id": "nutrition-science-501-l06-q6",
          "text": "In high-stakes Nutrition Science Specialization Studio execution, which communication protocol is strongest?",
          "skillId": "nutrition-science-501-skill-advanced-6",
          "options": [
            {
        ...
        {
          "id": "nutrition-science-501-l06-q7",
          "text": "A mature remediation loop in advanced Health Science should prioritize:",
          "skillId": "nutrition-science-501-skill-advanced-7",
          "options": [
            {
        ...
        {
          "id": "nutrition-science-501-l06-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Nutrition Science Specialization Studio?",
          "skillId": "nutrition-science-501-skill-advanced-8",
          "options": [
            {
    ...
    },
    {
      ...
      "title": "Nutrition Science Governance and Public Impact",
      "type": "video",
      "duration": 13,
      "learningAids": [
        {
    ...
    },
    {
      ...
      "title": "Nutrition Science Capstone Defense Lab",
      "type": "interactive",
      "duration": 16,
      "learningAids": [
        {
