...
export const UxDesign501Module: LearningModule = {
  "id": "ux-design-501",
      ...
      "chunks": [
        {
          ...
          "content": "This lesson defines advanced boundaries for UX Design, framing how research synthesis and interaction strategy interact across complex systems."
        },
        {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "skillId": "ux-design-501-skill-governance",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "ux-design-501-l03-q6",
          "text": "In high-stakes UX Design Specialization Studio execution, which communication protocol is strongest?",
          "skillId": "ux-design-501-skill-advanced-6",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "ux-design-501-l03-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in UX Design Specialization Studio?",
          "skillId": "ux-design-501-skill-advanced-8",
          "options": [
            {
              "id": "a",
      ...
      "chunks": [
        {
          ...
          "content": "Case focus: a high-traffic product redesign with conflicting usability findings across major user segments. Learners map strategic objectives, failure risks, and governance constraints before action."
        },
        {
