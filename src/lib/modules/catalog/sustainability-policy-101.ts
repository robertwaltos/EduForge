...
export const SustainabilityPolicy101Module: LearningModule = {
  "id": "sustainability-policy-101",
  "title": "Sustainability Policy Foundations",
  "description": "Level 101 curriculum in Sustainability Policy, focused on policy instrument design, transition economics, stakeholder governance, and long-term impact accountability through case-driven analysis, simulations, and assessment-backed mastery.",
  ...
  "lessons": [
    {
      "id": "sustainability-policy-101-l01",
      "title": "Sustainability Policy Core Foundations",
      "type": "video",
      "duration": 13,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l01-a1",
          "type": "image",
      ...
      "flashcards": [
        {
          "id": "sustainability-policy-101-l01-f1",
    ...
    {
      "id": "sustainability-policy-101-l02",
      "title": "Sustainability Policy Workflow Lab",
      "type": "interactive",
      "duration": 15,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l02-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
      ...
      "interactiveActivities": [
        {
          "id": "sustainability-policy-101-l02-act1",
          "type": "matching_pairs",
        ...
        {
          "id": "sustainability-policy-101-l02-act2",
    ...
    {
      "id": "sustainability-policy-101-l03",
      "title": "Checkpoint 1: Concepts and Methods",
      "type": "quiz",
      "duration": 10,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l03-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
      ...
      "questions": [
        {
          "id": "sustainability-policy-101-l03-q1",
          "text": "Which action most improves policy instrument design quality in practice?",
          "skillId": "sustainability-policy-101-skill-core",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "sustainability-policy-101-l03-q2",
          "text": "At level 101, the strongest emphasis is:",
          "skillId": "sustainability-policy-101-skill-level",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "sustainability-policy-101-l03-q3",
          "text": "What best strengthens transition economics reliability?",
          "skillId": "sustainability-policy-101-skill-reliability",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "sustainability-policy-101-l03-q4",
          "text": "When evaluating stakeholder governance, which approach is most defensible?",
          "skillId": "sustainability-policy-101-skill-eval",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "sustainability-policy-101-l03-q5",
          "text": "A mature long-term impact accountability model should include:",
          "skillId": "sustainability-policy-101-skill-governance",
          "options": [
            {
              "id": "a",
    ...
    {
      "id": "sustainability-policy-101-l04",
      "title": "Sustainability Policy Case Analysis",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l04-a1",
          "type": "mnemonic",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
    ...
    {
      "id": "sustainability-policy-101-l05",
      "title": "Sustainability Policy Simulation Studio",
      "type": "interactive",
      "duration": 16,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l05-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
      ...
      "interactiveActivities": [
        {
          "id": "sustainability-policy-101-l05-act1",
        ...
        {
          "id": "sustainability-policy-101-l05-act2",
          "type": "matching_pairs",
    ...
    {
      "id": "sustainability-policy-101-l06",
      "title": "Checkpoint 2: Systems Decisions",
      "type": "quiz",
      "duration": 10,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l06-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
      ...
      "questions": [
        {
          "id": "sustainability-policy-101-l06-q1",
          "text": "Which action most improves policy instrument design quality in practice?",
          "skillId": "sustainability-policy-101-skill-core",
          "options": [
            {
        ...
        {
          "id": "sustainability-policy-101-l06-q2",
          "text": "At level 101, the strongest emphasis is:",
          "skillId": "sustainability-policy-101-skill-level",
          "options": [
            {
        ...
        {
          "id": "sustainability-policy-101-l06-q3",
          "text": "What best strengthens transition economics reliability?",
          "skillId": "sustainability-policy-101-skill-reliability",
          "options": [
            {
        ...
        {
          "id": "sustainability-policy-101-l06-q4",
          "text": "When evaluating stakeholder governance, which approach is most defensible?",
          "skillId": "sustainability-policy-101-skill-eval",
          "options": [
            {
        ...
        {
          "id": "sustainability-policy-101-l06-q5",
          "text": "A mature long-term impact accountability model should include:",
          "skillId": "sustainability-policy-101-skill-governance",
          "options": [
            {
    ...
    {
      "id": "sustainability-policy-101-l07",
      "title": "Sustainability Policy Ethics and Policy Integration",
      "type": "video",
      "duration": 12,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l07-a1",
          "type": "image",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
    ...
    {
      "id": "sustainability-policy-101-l08",
      "title": "Sustainability Policy Capstone Planning Lab",
      "type": "interactive",
      "duration": 15,
      "learningAids": [
        {
          "id": "sustainability-policy-101-l08-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use the lesson structure, document assumptions, and validate your conclusions before final submission."
        }
      ...
      "interactiveActivities": [
        {
          "id": "sustainability-policy-101-l08-act1",
        ...
        {
          "id": "sustainability-policy-101-l08-act2",
