...
export const MicroCircuits601Module: LearningModule = {
  ...
  "lessons": [
    {
      "id": "micro-circuits-601-l01",
      "title": "Micro Circuits Advanced Foundations",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
          "id": "micro-circuits-601-l01-a1",
          "type": "image",
      ...
      "chunks": [
        {
          ...
          "content": "This lesson defines advanced scope boundaries for Micro Circuits, with focus on micro circuits systems diagnostics and micro circuits operations and execution design."
        },
        {
    ...
    {
      "id": "micro-circuits-601-l02",
      "title": "Micro Circuits Specialist Methods Lab",
      "type": "interactive",
      "duration": 17,
      "learningAids": [
        {
          "id": "micro-circuits-601-l02-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "interactiveActivities": [
        {
          "id": "micro-circuits-601-l02-act1",
          "type": "matching_pairs",
    ...
    {
      "id": "micro-circuits-601-l03",
      "title": "Checkpoint 1: Specialist Methods",
      "type": "quiz",
      "duration": 10,
      "learningAids": [
        {
          "id": "micro-circuits-601-l03-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "questions": [
        ...
        {
          "id": "micro-circuits-601-l03-q2",
          "text": "At level 601, strong execution for micro circuits operations and execution design requires:",
          "skillId": "micro-circuits-601-skill-execution",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "micro-circuits-601-l03-q4",
          "text": "Mature governance systems connect:",
          "skillId": "micro-circuits-601-skill-governance",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "micro-circuits-601-l03-q6",
          "text": "In high-stakes Micro Circuits Research and Leadership execution, which communication protocol is strongest?",
          "skillId": "micro-circuits-601-skill-advanced-6",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "micro-circuits-601-l03-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Micro Circuits Research and Leadership?",
          "skillId": "micro-circuits-601-skill-advanced-8",
          "options": [
            {
              "id": "a",
    ...
    {
      "id": "micro-circuits-601-l04",
      "title": "Micro Circuits Advanced Case Analysis",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
          "id": "micro-circuits-601-l04-a1",
          "type": "image",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "chunks": [
        {
          ...
          "content": "The case frames competing constraints in micro circuits systems diagnostics and micro circuits impact and tradeoff analysis."
        },
        {
    ...
    {
      "id": "micro-circuits-601-l05",
      "title": "Micro Circuits Simulation Clinic",
      "type": "interactive",
      "duration": 18,
      "learningAids": [
        {
          "id": "micro-circuits-601-l05-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "interactiveActivities": [
        {
          "id": "micro-circuits-601-l05-act1",
          "type": "scenario",
    ...
    {
      "id": "micro-circuits-601-l06",
      "title": "Checkpoint 2: Case and Simulation Mastery",
      "type": "quiz",
      "duration": 11,
      "learningAids": [
        {
          "id": "micro-circuits-601-l06-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "questions": [
        {
          "id": "micro-circuits-601-l06-q1",
          "text": "In advanced casework, the first requirement for defensible recommendations is:",
          "skillId": "micro-circuits-601-skill-case1",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "micro-circuits-601-l06-q4",
          "text": "Advanced governance is strongest when it:",
          "skillId": "micro-circuits-601-skill-case4",
          "options": [
            {
              "id": "a",
    ...
    {
      "id": "micro-circuits-601-l07",
      "title": "Micro Circuits Governance and Public Impact",
      "type": "video",
      "duration": 13,
      "learningAids": [
        {
          "id": "micro-circuits-601-l07-a1",
          "type": "image",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "flashcards": [
        {
          "id": "micro-circuits-601-l07-f1",
          "front": "Impact distribution",
          "back": "How outcomes are allocated across populations and timescales."
        },
        {
          "id": "micro-circuits-601-l07-f2",
          "front": "Decision traceability",
          "back": "An auditable record of evidence, ownership, and rationale."
        },
        {
          "id": "micro-circuits-601-l07-f3",
    ...
    {
      "id": "micro-circuits-601-l08",
      "title": "Micro Circuits Capstone Defense Lab",
      "type": "interactive",
      "duration": 16,
      "learningAids": [
        {
          "id": "micro-circuits-601-l08-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "interactiveActivities": [
        {
          "id": "micro-circuits-601-l08-act1",
