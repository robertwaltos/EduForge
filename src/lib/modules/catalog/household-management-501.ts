...
export const HouseholdManagement501Module: LearningModule = {
  "id": "household-management-501",
  "title": "Household Management Specialization Studio",
  ...
  "lessons": [
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l01-a1",
          "type": "image",
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l02-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l03-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "questions": [
        ...
        },
        {
          ...
          "text": "At level 501, strong execution for household management operations and execution design requires:",
        ...
        {
          "id": "household-management-501-l03-q6",
          "text": "In high-stakes Household Management Specialization Studio execution, which communication protocol is strongest?",
          "skillId": "household-management-501-skill-advanced-6",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "household-management-501-l03-q7",
          "text": "A mature remediation loop in advanced Household Management should prioritize:",
          "skillId": "household-management-501-skill-advanced-7",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "household-management-501-l03-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Household Management Specialization Studio?",
          "skillId": "household-management-501-skill-advanced-8",
          "options": [
            {
              "id": "a",
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l04-a1",
          "type": "image",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l05-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l06-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
      ...
      "questions": [
        ...
        {
          "id": "household-management-501-l06-q5",
          "text": "What is the best way to compare competing interventions in advanced Household Management?",
          "skillId": "household-management-501-skill-advanced-5",
          "options": [
            {
        ...
        {
          "id": "household-management-501-l06-q6",
          "text": "In high-stakes Household Management Specialization Studio execution, which communication protocol is strongest?",
          "skillId": "household-management-501-skill-advanced-6",
          "options": [
            {
        ...
        {
          "id": "household-management-501-l06-q7",
          "text": "A mature remediation loop in advanced Household Management should prioritize:",
          "skillId": "household-management-501-skill-advanced-7",
          "options": [
            {
        ...
        {
          "id": "household-management-501-l06-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Household Management Specialization Studio?",
          "skillId": "household-management-501-skill-advanced-8",
          "options": [
            {
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l07-a1",
          "type": "image",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "household-management-501-l08-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Use a structured method, make assumptions explicit, and validate recommendations with measurable evidence."
        }
