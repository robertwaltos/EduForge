...
export const ElectricalEngineering601Module: LearningModule = {
  ...
  "lessons": [
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "text": "At level 601, strong execution for power systems operations and execution design requires:",
        ...
        {
          "id": "electrical-engineering-601-l03-q5",
          "text": "What is the best way to compare competing interventions in advanced Power Systems?",
          "skillId": "electrical-engineering-601-skill-advanced-5",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "electrical-engineering-601-l03-q6",
          "text": "In high-stakes Electrical Engineering Research and Leadership execution, which communication protocol is strongest?",
          "skillId": "electrical-engineering-601-skill-advanced-6",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "electrical-engineering-601-l03-q7",
          "text": "A mature remediation loop in advanced Power Systems should prioritize:",
          "skillId": "electrical-engineering-601-skill-advanced-7",
          "options": [
            {
              "id": "a",
        ...
        {
          "id": "electrical-engineering-601-l03-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Electrical Engineering Research and Leadership?",
          "skillId": "electrical-engineering-601-skill-advanced-8",
          "options": [
            {
              "id": "a",
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "id": "electrical-engineering-601-l06-q5",
          "text": "What is the best way to compare competing interventions in advanced Power Systems?",
          "skillId": "electrical-engineering-601-skill-advanced-5",
          "options": [
            {
        ...
        {
          "id": "electrical-engineering-601-l06-q6",
          "text": "In high-stakes Electrical Engineering Research and Leadership execution, which communication protocol is strongest?",
          "skillId": "electrical-engineering-601-skill-advanced-6",
          "options": [
            {
        ...
        {
          "id": "electrical-engineering-601-l06-q7",
          "text": "A mature remediation loop in advanced Power Systems should prioritize:",
          "skillId": "electrical-engineering-601-skill-advanced-7",
          "options": [
            {
        ...
        {
          "id": "electrical-engineering-601-l06-q8",
          "text": "Which portfolio decision rule best balances performance and resilience in Electrical Engineering Research and Leadership?",
          "skillId": "electrical-engineering-601-skill-advanced-8",
          "options": [
            {
