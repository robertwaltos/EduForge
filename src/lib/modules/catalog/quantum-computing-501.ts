...
export const QuantumComputing501Module: LearningModule = {
  ...
  "lessons": [
    {
      "id": "quantum-computing-501-l01",
      "title": "Quantum Computing Advanced Foundations",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
      ...
      "flashcards": [
        ...
        {
          "id": "quantum-computing-501-l01-f3",
          "front": "Hybrid Quantum-Classical Optimization Workflows",
          "back": "Evaluation discipline for identifying true gains and hidden costs."
        }
      ]
    },
    {
      "id": "quantum-computing-501-l02",
      "title": "Quantum Computing Specialist Methods Lab",
      "type": "interactive",
      "duration": 17,
      "learningAids": [
        {
      ...
      "interactiveActivities": [
        {
          "id": "quantum-computing-501-l02-act1",
          "type": "matching_pairs",
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "id": "quantum-computing-501-l03-q4",
    ...
    {
      "id": "quantum-computing-501-l04",
      "title": "Quantum Computing Advanced Case Analysis",
      "type": "video",
      "duration": 14,
      "learningAids": [
        {
    ...
    {
      "id": "quantum-computing-501-l05",
      "title": "Quantum Computing Simulation Clinic",
      "type": "interactive",
      "duration": 18,
      "learningAids": [
        {
      ...
      "interactiveActivities": [
        {
          "id": "quantum-computing-501-l05-act1",
          "type": "scenario",
          "title": "Adverse-Condition Decision Run",
          "description": "Run a high-pressure quantum computing scenario and tune controls under uncertainty."
        }
      ]
    },
    {
      "id": "quantum-computing-501-l06",
    ...
    {
      "id": "quantum-computing-501-l07",
      "title": "Quantum Computing Governance and Public Impact",
      "type": "video",
      "duration": 13,
      "learningAids": [
        {
      ...
      "flashcards": [
        {
          "id": "quantum-computing-501-l07-f1",
          "front": "Impact distribution",
          "back": "How outcomes are allocated across populations and timescales."
        },
        {
          "id": "quantum-computing-501-l07-f2",
          "front": "Decision traceability",
          "back": "An auditable record of evidence, ownership, and rationale."
        },
        {
          "id": "quantum-computing-501-l07-f3",
    ...
    {
      "id": "quantum-computing-501-l08",
      "title": "Quantum Computing Capstone Defense Lab",
      "type": "interactive",
      "duration": 16,
      "learningAids": [
        {
      ...
      "interactiveActivities": [
        {
          "id": "quantum-computing-501-l08-act1",
