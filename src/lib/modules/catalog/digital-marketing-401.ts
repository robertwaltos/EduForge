...
export const DigitalMarketing401Module: LearningModule = {
      ...
      "chunks": [
        {
          ...
          "content": "Digital Marketing at level 401 requires precise language. We define scope boundaries, identify the operating unit of analysis, and align terminology so decisions can be compared across teams."
        },
        {
      ...
      "questions": [
        {
          ...
          "skillId": "digital-marketing-401-skill-core",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "digital-marketing-401-skill-process",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "digital-marketing-401-skill-eval",
          "options": [
            {
              "id": "a",
        ...
        },
        {
          ...
          "skillId": "digital-marketing-401-skill-strategy",
          "options": [
            {
              "id": "a",
